...
## Objectives
- Finding relationship between car properties and carbon emission.
- Checking correlation between car properties and carbon emission.
...
The visualisation contains valuable insights derived from the analysis of 7,134 vehicles which allows to understand the relationship between the vehicle properties and quantity of CO2 emissions produced. The analysis takes into consideration various variables such as: fuel type, vehicle class, engine size, number of cylinders, transmission type, average fuel consumption in city and highway. 
...
Note: The average CO2 emissions are above the normal range and requires high attention. The European Commission's target by 2024 is to reach emission levels of 95g CO2/km for cars and 147g CO2/km for vans.
